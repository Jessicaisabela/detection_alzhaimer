...
for i in range(best_params['n_layers']):
    ...
    final_model.add(Dense(units, activation=best_params['activation']))
    final_model.add(Dropout(best_params['dropout_rate']))
...
pd.DataFrame(input_train_scaled, columns=input_train_df.columns).to_csv('./archive/train/input_train_scaled.csv', index=False)
