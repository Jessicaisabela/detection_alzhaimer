...
input_train.to_csv('/home/bruno/detection_alzhaimer/archive/train/input_train.csv', index=False)

input_test = pd.DataFrame(input_test)

input_test.to_csv('/home/bruno/detection_alzhaimer/archive/test/input_test.csv', index=False)

output_train = pd.DataFrame (output_train)

output_train.to_csv('/home/bruno/detection_alzhaimer/archive/train/output_train.csv', index=False)

output_test = pd.DataFrame(output_test)

output_test.to_csv('/home/bruno/detection_alzhaimer/archive/test/output_test.csv', index=False)
